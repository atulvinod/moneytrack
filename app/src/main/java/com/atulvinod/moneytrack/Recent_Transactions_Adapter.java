...
public class Recent_Transactions_Adapter extends RecyclerView.Adapter<Recent_Transactions_Adapter.View_Holder>{
    ...
    public Recent_Transactions_Adapter(Context context,RapidFloatingActionButton btn,RapidFloatingActionLayout layout,Transaction_ViewModel model){
    ...
    public Recent_Transactions_Adapter(Context c,Transaction_ViewModel model){
        this.context = context;
    ...
    /**This function has to be called before the adapter is attached to the recycler view,
     It determines the origin of the activity that is calling the adapter, if its the Overview fragment then
     the Recycler view has to display only 3 elements**/
